...
<?php $__env->startSection("content"); ?>
    <div class="col-sm-8">
        <blockquote>
            ...
            <button class="btn btn-default topic-submit"  data-toggle="modal" data-target="#topic_submit_modal" topic-id="<?php echo e($topic->id); ?>" _token="" type="button">投稿</button>
        </blockquote>
    </div>
...
<?php echo $__env->make("layout.main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Code/social-contact/resources/views/topic/show.blade.php ENDPATH**/ ?>